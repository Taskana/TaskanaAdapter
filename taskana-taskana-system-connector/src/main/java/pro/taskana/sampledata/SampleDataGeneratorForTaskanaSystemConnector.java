 ...
 */
public class SampleDataGeneratorForTaskanaSystemConnector {

    private static final Logger LOGGER = LoggerFactory.getLogger(SampleDataGeneratorForTaskanaSystemConnector.class);
    ...
    public SampleDataGeneratorForTaskanaSystemConnector(DataSource dataSource) throws SQLException {
    ...
    public void generateSampleData(String schemaName) {
        ...
        Stream.of(WORKBASKET, DISTRIBUTION_TARGETS, CLASSIFICATION, TASK, ATTACHMENT, WORKBASKET_ACCESS_LIST,
            ...
            .map(s -> SampleDataGeneratorForTaskanaSystemConnector.parseAndReplace(now, s))
