...
/**
 * This class is responsible for setting an invalid String variable "taskana.workbasket-key" in a
 * test scenario.
 */
public class InvalidWorkbasketKeySetter implements JavaDelegate {
  ...
  public void execute(DelegateExecution execution) {
    ...
    execution.setVariable("taskana.workbasket-key", "invalidWorkbasketKey");
  }
}
