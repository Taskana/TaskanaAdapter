...
public interface TaskanaConfigurationProperties {
  ...
  String TASKANA_ADAPTER_OUTBOX_DATASOURCE_JNDI =
      "taskana.adapter.outbox.datasource.jndi";
  String TASKANA_ADAPTER_OUTBOX_DATASOURCE_DRIVER =
      "taskana.adapter.outbox.datasource.driver";
  String TASKANA_ADAPTER_OUTBOX_DATASOURCE_URL =
      "taskana.adapter.outbox.datasource.url";
  String TASKANA_ADAPTER_OUTBOX_DATASOURCE_USERNAME =
      "taskana.adapter.outbox.datasource.username";
  String TASKANA_ADAPTER_OUTBOX_DATASOURCE_PASSWORD =
