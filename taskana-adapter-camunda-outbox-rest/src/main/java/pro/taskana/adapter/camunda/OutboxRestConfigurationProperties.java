...
import pro.taskana.adapter.camunda.outbox.rest.exception.SystemException;

public class OutboxRestConfigurationProperties {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(OutboxRestConfigurationProperties.class);

  private final Properties outboxProperties = new Properties();

  private OutboxRestConfigurationProperties() {
  ...
  public static OutboxRestConfigurationProperties getInstance() {
    return OutboxRestConfigurationProperties.LazyHolder.INSTANCE;
  }
  ...
  private static class LazyHolder {
    private static final OutboxRestConfigurationProperties INSTANCE =
        new OutboxRestConfigurationProperties();
  }
}
