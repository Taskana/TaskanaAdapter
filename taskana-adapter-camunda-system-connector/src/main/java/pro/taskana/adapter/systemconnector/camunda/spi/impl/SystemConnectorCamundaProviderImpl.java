...
public class SystemConnectorCamundaProviderImpl implements SystemConnectorProvider {
        ...
        private static final Logger LOGGER = LoggerFactory.getLogger(SystemConnectorCamundaProviderImpl.class);
    ...
    public List<SystemConnector> create() {
        ...
        //camundaSystemURLs.getUrls().forEach(camundaSystemURL -> result.add(new CamundaSystemConnectorImpl(camundaSystemURL)));
