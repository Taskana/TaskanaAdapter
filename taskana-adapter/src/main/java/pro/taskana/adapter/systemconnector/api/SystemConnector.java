...
public interface SystemConnector {
     ...
     * on the Implementation of the System Connector, it may ignore this call.
     *
    ...
    /**
     * With this call the Adapter notifies the SystemConnector that a list of Taskana Tasks has been terminated. The
     * rationale for this action is that referenced tasks in the external system were terminated. Depending on the
     * Implementation of the System Connector, it may ignore this call.
     *
     * @param referencedTasks
