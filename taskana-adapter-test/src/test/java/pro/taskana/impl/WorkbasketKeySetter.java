...
/**
 * This class is responsible for setting the String variable "taskana.workbasket-key" in a test scenario.
 */
public class WorkbasketKeySetter implements JavaDelegate {
    ...
    private String getDomainName(DelegateExecution execution) {
        ...
        try {
            ...
            LOGGER.warn("Caught {} while trying to retrieve the taskana.domain property from a process model", e);
