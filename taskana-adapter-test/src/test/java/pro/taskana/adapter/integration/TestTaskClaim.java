 ...
 *
 */
@SpringBootTest(classes = TaskanaAdapterTestApplication.class, webEnvironment = SpringBootTest.WebEnvironment.DEFINED_PORT)
...
public class TestTaskClaim extends AbsIntegrationTest {
    ...
    @WithAccessId(
        ...
        groupNames = {"admin"})
    @Test
    public void claim_of_taskana_task_should_claim_unclaimed_camunda_task() throws TaskNotFoundException,
        ...
        for (String camundaTaskId : camundaTaskIds) {
            ...
            boolean noAssigneeSet = this.camundaProcessengineRequester.isCorrectAssignee(camundaTaskId, null);
            ...
            boolean assigneeSetSuccessfully = this.camundaProcessengineRequester.isCorrectAssignee(camundaTaskId, "teamlead_1");
    ...
    @WithAccessId(
        ...
        groupNames = {"admin"})
    @Test
    public void claim_of_taskana_task_should_claim_already_claimed_camunda_task() throws TaskNotFoundException,
        NotAuthorizedException, JSONException, InterruptedException, InvalidOwnerException, InvalidStateException {

        String processInstanceId = this.camundaProcessengineRequester
            .startCamundaProcessAndReturnId("simple_user_task_process_with_assignee_set", "");
        List<String> camundaTaskIds = this.camundaProcessengineRequester
            .getTaskIdsFromProcessInstanceId(processInstanceId);
    ...
    @WithAccessId(
        ...
        groupNames = {"admin"})
    @Test
    public void cancel_claim_of_taskana_task_should_cancel_claim_of_camunda_task() throws TaskNotFoundException,
        NotAuthorizedException, JSONException, InterruptedException, InvalidOwnerException, InvalidStateException {
    ...
    @WithAccessId(
        ...
        groupNames = {"admin"})
    @Test
    public void claim_of_taskana_task_after_cancel_claim_should_claim_task_in_camunda_again() throws TaskNotFoundException,
        NotAuthorizedException, JSONException, InterruptedException, InvalidOwnerException, InvalidStateException {
        ...
        for (String camundaTaskId : camundaTaskIds) {
            ...
            boolean assigneeSetSuccessfullyAgain = this.camundaProcessengineRequester.isCorrectAssignee(camundaTaskId, "teamlead_1");
